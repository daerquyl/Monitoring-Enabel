	<div class="row mt-3">
		...
		<div class="col-3 action-panel">
			<p>
				<input id="organization-search" type="text"  value="" placeholder=" Recherche"/>
			</p>
		</div>
		<div class="col-7 action-panel text-right">
			<p class="d-none d-md-block p-0 mb-0">
				<a href="" class="text-light" data-toggle="modal" data-target="#organization_modal"><button class="create-link btn btn-danger"><i class="fa fa-plus"></i> Nouveau</button></a>
			...
			<p class="d-md-none p-0 mb-0">
				<a href="" class="text-light" data-toggle="modal" data-target="#organization_modal"><button class="create-link btn btn-danger"><i class="fa fa-plus"></i></button></a>
