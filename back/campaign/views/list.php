...
<div class="container">
	...
	<div class="row mt-1">
		...
		<?php require_once($_SERVER['DOCUMENT_ROOT']."/monitoring/layouts/flash.php"); ?>
			<div class="card lead">
				<div class="card-header text-center text-white bg-dark">
					<h5 class="p-0 m-0"><i class="fa fa-braille"></i> P&eacute;riode de rapportage</h5>
				</div>
				<div class="card-body">
		...
		<div class="col-1"></div>
		<?php require_once("parts/start_end_deletion_modal.php"); ?>
		<?php require_once("parts/form_modal.php"); ?>
	</div>
</div>
<script src="parts/start_end_delete.js"></script>
