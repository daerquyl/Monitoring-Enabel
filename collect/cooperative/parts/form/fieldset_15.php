			...
			<div class="base">
				...
				<div class="form-group pb-0 pt-0 mt-0">
					...
					<select class="form-control" 
						...
						<option value="ANCAR">ANCAR</option>
						<option value="ISRA">ISRA</option>
						<option value="ECLOSIO">ECLOSIO</option>
				...
				<div class="form-group pb-0 pt-0 mt-0">
					...
					<select class="form-control" id="type" name="type[]"
						data-validation="non_empty_select"
						data-validation-depends-on="capacity_building" 
						data-validation-depends-on-value="true" multiple
						<option value="-">-</option>
				...
				<div class="form-group pb-0 pt-0 mt-0">
					...
					<select class="form-control" id="trained_instances" name="trained_instances[]"
						multiple
						data-validation="non_empty_select"
						data-validation-depends-on="capacity_building" 
						data-validation-depends-on-value="true">
						...
						<option value="BE">Bureau ex&eacute;cutif</option>
						<option value="CS">Conseil de surveillance</option>
						<option value="CD">Comit&eacute; directeur</option>
						<option value="CT">Commission technique</option>
						<option value="AUTRE">Autre</option>
					</select>        
				</div>		
				<!-- Autre Appui -->
