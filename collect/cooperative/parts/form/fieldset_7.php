	...
	-->
	<fieldset id="7">
		<!-- Nombre d'employes(Different du manager) -->
		<div class="form-group pb-0 pt-0 mt-0">
			<label for="employee_count" class="font-weight-bold">Nombre d'employ&eacute;s(diff&eacute;rent du g&eacute;rant)</label>
			<input class="form-control" type="number" id="employee_count" name="employee_count"/>       
		</div>	
		<!-- Nombre d'employes(Different du chef d'exploitation) -->
		<select
			...
			<div class="base" id="e1">
				...
				<div class="form-group pb-0 pt-0 mt-0 multiple">
					...
					<div class="checkboxes_container">
						<div class="form-group"><input type="checkbox" class="multiple-checkbox ect" value="CSF"><label> CSF</label></div>
						<div class="form-group"><input type="checkbox" class="multiple-checkbox ect" value="CSC"><label> CSC</label></div>
						<div class="form-group"><input type="checkbox" class="multiple-checkbox ect" value="HIV"><label> HIV</label></div>
					</div>
				</div>		
				...
				<div class="form-group pb-0 pt-0 mt-0 multiple">
					...
					data-validation="required" data-validation-depends-on="employee_count_mark" data-validation-depends-on-value="true" />
					<div class="checkboxes_container">
						<div class="form-group"><input type="checkbox" class="multiple-checkbox eoct" value="CSF"><label> CSF</label></div>
						<div class="form-group"><input type="checkbox" class="multiple-checkbox eoct" value="CSC"><label> CSC</label></div>
						<div class="form-group"><input type="checkbox" class="multiple-checkbox eoct" value="HIV"><label> HIV</label></div>
					</div>
				</div>		
			</div>
		</div>
