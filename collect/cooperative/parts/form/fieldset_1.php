	...
	<fieldset id="1" class="active">							
		...
		<!-- Champ type collect -->
		<input type="hidden" id="record" name="record" value="cooperative"/>
		...
		<div class="form-group pb-0 pt-0 mt-0">
			...
			<select class="form-control" id="commune_id" name="commune_id" readonly>
				<option value="-">-</option>
				<?php
		...
		<div class="form-group form-input-required pb-0 pt-0 mt-0">
			<label for="village" class="font-weight-bold">Villages polaris&eacute;s</label>
			<input class="form-control" type="text" id="polarized_villages" name="polarized_villages"
