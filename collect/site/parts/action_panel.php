	<div class="row mt-3">
		...
		<div class="col-3 action-panel">
			<p>
				<input id="site-search" type="text"  value="" placeholder=" Recherche"/>
			</p>
		</div>
		<div class="col-7 action-panel text-right">
			<p class="d-none d-md-block p-0 mb-0">
				<a href="" class="text-light" data-toggle="modal" data-target="#site_modal"><button class="create-link btn btn-danger"><i class="fa fa-plus"></i> Nouveau</button></a>
				<a href="/monitoring/collect/index.php" class="text-light"><button class="btn btn-secondary">Suivies</button></a>
			...
			<p class="d-md-none p-0 mb-0">
				<a href="" class="text-light" data-toggle="modal" data-target="#site_modal"><button class="create-link btn btn-danger"><i class="fa fa-plus"></i></button></a>
