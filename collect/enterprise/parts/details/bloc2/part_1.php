				...
				<table class="table table-bordered table-responsive table-sm" >
					<thead class="">
						<tr>
							...
							<th class="text-center">Relation avec le chef d'exploitation</th>
							...
							<th class="text-center">Trimestres travaill&eacute;es cette annee dans cette entreprise</th>
							<th class="text-center">Trimestres travaill&eacute;es ailleurs cette annee</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td class="text-center"><span class="text-danger"><?= $employee['employee_worked_trimesters'] ?></span></td>						
							<td class="text-center"><span class="text-danger"><?= $employee['employee_other_worked_trimesters'] ?></span></td>											
						</tr>
					</tbody>
				</table>
				<hr />
