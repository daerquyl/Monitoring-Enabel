				<div id="commune" class="indicator table-responsive">	
					<table class="table table-sm table-striped">
						<thead>
							<tr>
								...
								?>
								<th style="font-size:0.8em"><?= $commune['name'] ?></th>
								<?php
								}
								?>
							</tr>
						...
						<tbody>
							...
							<tr>
								...
								<?php 
								foreach($communes as $commune){
									$indicator_value = $indicators[$indicator_key]['data']['commune'][$commune['name']] ?? "-";
